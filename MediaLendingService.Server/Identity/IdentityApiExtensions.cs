...
public static class IdentityApiExtensions
{
    ...
    /// Based on <see cref="IdentityApiEndpointRouteBuilderExtensions.MapIdentityApi{TUser}(IEndpointRouteBuilder)"/>.
    /// </summary>
    ...
    public static IEndpointConventionBuilder MapApplicationIdentityApi(this IEndpointRouteBuilder endpoints)
    {
            ...
            ([FromBody] RegisterRequestDto registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                throw new NotSupportedException($"{nameof(MapApplicationIdentityApi)} requires a user store with email support.");
            }
            ...
            try
            {
                var roleResult = await userManager.AddToRoleAsync(user, registration.Role.GetRoleName());
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(MapApplicationIdentityApi)}-{finalPattern}";
